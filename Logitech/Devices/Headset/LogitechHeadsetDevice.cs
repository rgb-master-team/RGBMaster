...
namespace Logitech.Devices.Headset
{
    ...
    {
        public LogitechHeadsetDevice(LogitechHeadsetDeviceMetadata logitechDeviceMetadata) : base(logitechDeviceMetadata)
        { }
        ...
        {
            LogitechGSDK.LogiLedSetLightingForTargetZone(DeviceType.Headset, 0, (int)(100 * (double)color.R / byte.MaxValue), (int)(100 * (double)color.G / byte.MaxValue), (int)(100 * (double)color.B / byte.MaxValue));
            LogitechGSDK.LogiLedSetLightingForTargetZone(DeviceType.Headset, 1, (int)(100 * (double)color.R / byte.MaxValue), (int)(100 * (double)color.G / byte.MaxValue), (int)(100 * (double)color.B / byte.MaxValue));
