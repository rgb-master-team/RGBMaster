...
Import-Certificate -FilePath "RGBMasterWap_2.3.0.0_x64.cer" -CertStoreLocation Cert:\LocalMachine\TrustedAppRoot
...
Add-AppPackage -path "RGBMasterWap_2.3.0.0_x64.msixbundle"